...
class _ManualGuidanceScreenState extends State<ManualGuidanceScreen> {
  ...
  void _buildFireGuidance() {
    ...
    _guidance = [
      ...
      "Turn off electricity or gas if it is safe to do so.",
    ...
    if (widget.victimCondition == "Trapped") {
      _guidance.insert(
        1,
        "Inform emergency responders that someone is trapped inside.",
      );
    }

    if (widget.danger == "Fuel Leak") {
      _guidance.insert(2, "Keep everyone away from possible ignition sources.");
    }
  }
            ...
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    _infoRow(
                      Icons.location_on,
                      "Location",
                      widget.includeLocation ? "Included" : "Not Included",
                      textDark,
                      textSoft,
                    ),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text("Continue to SOS Preview"),
